...
vehicle.AeroWeightNorm = 15.46; % Weight of Aero Package per square meter of frontal area
...
%% Variables
vehicle.AeroFrontalArea = 0.9625; % Frontal area in m^2, default value543
